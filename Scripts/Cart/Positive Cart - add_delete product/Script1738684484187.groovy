...
WebUI.scrollToElement(findTestObject('StackDemo/Cart/Delete Product 3'), 0)

WebUI.click(findTestObject('Object Repository/StackDemo/Cart/Delete Product 3'))
...
WebUI.verifyEqual(cartCount, '2', FailureHandling.CONTINUE_ON_FAILURE)
