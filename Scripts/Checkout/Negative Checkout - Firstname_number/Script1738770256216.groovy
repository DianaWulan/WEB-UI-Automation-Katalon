...
WebUI.setText(findTestObject('StackDemo/Checkout/input_First Name_firstNameInput'), '12345')
...
// Popup Alert
String message = WebUI.executeJavaScript('return document.querySelector("#firstNameInput").validationMessage;', null)
