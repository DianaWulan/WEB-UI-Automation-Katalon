...
WebUI.setText(findTestObject('StackDemo/Checkout/input_Address_addressLine1Input'), 'Bekasi@#$%')
...
//Pop up Alert
String message = WebUI.executeJavaScript('return document.querySelector("#addressLine1Input").validationMessage;', null)
