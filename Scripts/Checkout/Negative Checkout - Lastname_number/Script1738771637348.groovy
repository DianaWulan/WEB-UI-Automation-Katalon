...
WebUI.setText(findTestObject('StackDemo/Checkout/input_Last Name_lastNameInput'), '12345')
...
// Pop up Alert
String message = WebUI.executeJavaScript('return document.querySelector("#lastNameInput").validationMessage;', null)
